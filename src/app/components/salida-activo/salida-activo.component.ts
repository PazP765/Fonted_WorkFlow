...
@Component({
  selector: 'app-salida-activo',
  templateUrl: './salida-activo.component.html',
  styleUrls: ['./salida-activo.component.css']
})
export class SalidaActivoComponent implements OnInit {
